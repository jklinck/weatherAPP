...
$(function(){
	...
	function success(position){
		...
		weatherURL='http://api.openweathermap.org/data/2.5/weather?lat='+latitude+'&lon='+longitude+'&APPID='+openWeatherAPI;
		mapsURL = 'https://maps.googleapis.com/maps/api/geocode/json?latlng=' + latitude + '%2C' + longitude + '&language=en';
		gMaps();
	} 
	...
	// New York Times API
	function nyt(){
		    nytUrl = 'http://api.nytimes.com/svc/search/v2/articlesearch.json?&q='+city+','+state+'&page=0&api-key='+nytAPI;
	...
	// Google Maps API
	function gMaps(){
		$.getJSON(mapsURL).done(function(location) {
